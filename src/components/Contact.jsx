...
const Contact = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
     await axios.post("https://getform.io/f/apjjxqva",userInfo);
  ...
  return (
    <>
     <div name="Contact" className="max-w-screen-2xl container mx-auto px-4 md:px-20 my-16">
        <h1 className='text-3xl font-bolt mb-4'>Contact Me</h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)}
            ...
            <div className='flex flex-col mb-4'>
              ...
              <input {...register("name",{required:true})}
               ...
               id='name' name='name' type="text"  placeholder='Enter Your FullName'/>
            ...
            <div className='flex flex-col mb-4'>
              ...
              <textarea {...register("message",{required:true})}
               className='shadow rounded-lg appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline'
               id='message' name='message' type="text"  placeholder='Enter Your Query'/>
